...
// Polyfill mb_ord (added in PHP v7.2.0+)
// https://stackoverflow.com/questions/35575721/ord-doesnt-work-with-utf-8/42600959
...
class EmojiRenderer extends Renderer {
    public static $emoji_list;

    public function text($_text) {

        return preg_replace_callback('/:(\w+):/', function($m){
            $name = $m[1];

            if(!isset(self::$emoji_list[$name])) {
              return $m[0];
            }
            $char = self::$emoji_list[$name];
            ...
            // Emoji is an Unicode char
            } else {
              $hexa = sprintf("%x", mb_ord($char));
